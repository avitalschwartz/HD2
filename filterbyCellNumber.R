...
library(Matrix)
mat <- readMM("/ems/elsc-labs/meshorer-e/avital.schwartz1/HD/HD2/GSE152058_human_snRNA_processed_counts.mtx")

library(readr)
colData <- read_tsv("/ems/elsc-labs/meshorer-e/avital.schwartz1/HD/HD2/GSE152058_human_snRNA_processed_coldata.tsv")
rowData <- read_tsv("/ems/elsc-labs/meshorer-e/avital.schwartz1/HD/HD2/GSE152058_human_snRNA_processed_rowdata.tsv")
...
mat_filt <- mat[, keep_idx, drop = FALSE]

out_dir <- "/ems/elsc-labs/meshorer-e/avital.schwartz1/HD/HD2"

writeMM(mat_filt, file.path(out_dir, "GSE152058_human_snRNA_processed_counts_filtered.mtx"))
